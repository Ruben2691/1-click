  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto text-center pb-12">
        ...
        <AuthLogo />
        {/* Page title */}
        <h1 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60">Create your free account</h1>
      </div>
        ...
        <form action={signup}>
          <div className="space-y-4">
            <div>
              ...
              <input id="company" className="form-input w-full" type="text" placeholder="mE.g., Acme Inc." required name='company'/>
            </div>
            <div>
              ...
              <input id="full-name" className="form-input w-full" type="text" placeholder="E.g., Mark Rossi" required name='full-name'/>
            </div>
            <div>
              ...
              <input id="email" className="form-input w-full" type="email" placeholder="markrossi@company.com" required name='email'/>
            </div>
            <div>
              ...
              <input id="password" className="form-input w-full" type="password" autoComplete="on" required name='password'/>
            </div>
            <div>
              ...
              <select id="referrer" className="form-select text-sm py-2 w-full" required name='referrer'>
